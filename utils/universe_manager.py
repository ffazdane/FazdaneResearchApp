...
_DEFAULTS = {
    ...
    "Best Option Spread Tickers": {
        "tickers": ["AAL", "AAOI", "AAP", "AAPL", "ABBV", "ADBE", "ADI", "ALAB", "AMAT", "AMD", "AMGN", "AMZN", "ANET", "APD", "APP", "ARKK", "ARM", "ARQQ", "ASML", "ASTS", "AVGO", "AXP", "BA", "BABA", "BAC", "BIDU", "BLDR", "BLK", "BX", "C", "CAH", "CAT", "CBRE", "CLS", "COF", "COHR", "COIN", "COP", "COST", "CRDO", "CRM", "CRWD", "CSX", "CVX", "DAL", "DASH", "DDOG", "DELL", "DIA", "DIS", "DKNG", "DKS", "DOV", "EEM", "ELF", "EOG", "F", "FCX", "FDX", "FLUT", "FN", "FSLR", "FTAI", "FUTU", "FXI", "GD", "GDX", "GDXJ", "GE", "GEV", "GILD", "GLD", "GM", "GNRC", "GOOG", "GOOGL", "GRAL", "GS", "H", "HD", "HON", "HOOD", "HSY", "IBKR", "IBM", "INSM", "INTC", "IWM", "JBHT", "JBL", "JD", "JNJ", "JPM", "KKR", "KLAC", "KO", "KRE", "LECO", "LEU", "LI", "LLY", "LMND", "LMT", "LRCX", "LUV", "LYV", "MA", "MAR", "MCD", "MDB", "META", "MMM", "MOD", "MRK", "MRVL", "MS", "MSFT", "MSTR", "MTB", "MTN", "MU", "NEM", "NET", "NFLX", "NIO", "NKE", "NNE", "NOW", "NTRS", "NUE", "NVDA", "NXPI", "OLLI", "ON", "ORCL", "PANW", "PDD", "PEP", "PFE", "PG", "PINS", "PLNT", "PLTR", "PNC", "PYPL", "QCOM", "QQQ", "RBLX", "RCL", "RDDT", "RIVN", "ROKU", "RTX", "SBUX", "SCHW", "SE", "SEZL", "SHOP", "SLV", "SMH", "SN", "SNAP", "SNOW", "SOFI", "SPMO", "SPOT", "SPY", "SQ", "STX", "TEAM", "TEL", "TGT", "TKO", "TLN", "TLT", "TM", "TOL", "TSLA", "TSM", "TTWO", "TXN", "UAL", "UNG", "UNH", "UNP", "UPS", "UPST", "USO", "V", "VRT", "VST", "WCC", "WDAY", "WELL", "WFC", "WMT", "XOM", "XOP", "XPEV", "XPO", "ZS"],
        "benchmark": "SPY",
